...
window.onload=function(){
    if (/Edge\/\d./i.test(navigator.userAgent)){
        window.alert('Er zijn op het moment problemen met deze browser, samenvattingen zullen waarschijnlijk niet openen (wel downloaden). Om dit op te lossen kan je google chrome of firefox gebruiken.');
    }
}
